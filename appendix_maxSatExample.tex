%
\section{\maxSat\ Example: Details}%
%
%%
...
\end{itemize}%
\centering\hyperlink{maxSatInteractiveDemoStart}{\beamergotobutton{go back to interactive demo slides}}%
\end{frame}%
%%
%
\begin{frame}[t]%
...
\only<6->{\centering\hyperlink{maxSatInteractiveDemoEnd}{\beamergotobutton{continue after end of interactive demo slides}}}%
%
\locateWithCaption{2-}{%
